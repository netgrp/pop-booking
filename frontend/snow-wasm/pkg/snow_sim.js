 ...
 * @param {number} height
 */
export function snow_init(width, height) {
    const ret = wasm.snow_init(width, height);
    if (ret[1]) {
 ...
 * @param {number} height
 */
export function snow_resize(width, height) {
    const ret = wasm.snow_resize(width, height);
    if (ret[1]) {
        throw takeFromExternrefTable0(ret[0]);
    }
}
 ...
 * @param {number} target
 */
export function snow_pointer_wind(target) {
    wasm.snow_pointer_wind(target);
}
 ...
 * @param {number} dy
 */
export function snow_pointer_move(x, y, dx, dy) {
    const ret = wasm.snow_pointer_move(x, y, dx, dy);
    if (ret[1]) {
        throw takeFromExternrefTable0(ret[0]);
    }
}
 ...
 */
export function snow_step(delta_ms) {
    const ret = wasm.snow_step(delta_ms);
    if (ret[1]) {
        throw takeFromExternrefTable0(ret[0]);
    }
}

export function snow_reset() {
    const ret = wasm.snow_reset();
    if (ret[1]) {
        throw takeFromExternrefTable0(ret[0]);
    }
}
 ...
 * @param {number} b
 */
export function snow_set_tint(r, g, b) {
    const ret = wasm.snow_set_tint(r, g, b);
    if (ret[1]) {
        throw takeFromExternrefTable0(ret[0]);
    }
}
 ...
 * @returns {number}
 */
export function snow_dynamic_count() {
    const ret = wasm.snow_dynamic_count();
    return ret >>> 0;
}
 ...
 * @returns {number}
 */
export function snow_inactive_count() {
    const ret = wasm.snow_inactive_count();
    return ret >>> 0;
}
 ...
 */
export function snow_pile_bins() {
    const ret = wasm.snow_pile_bins();
    if (ret[2]) {
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('snow_sim_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
